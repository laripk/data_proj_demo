class FieldInfo
  ...
  def self.find(a_name)
    all[a_name]
  end
  
  def self.all
    list = {}
    list[:country] = FieldInfo.new({
      :name => :country,
    ...
    list[:household_income_year] = FieldInfo.new({
    ...
    list[:primary_household_income] = FieldInfo.new({
    ...
    list[:population_year] = FieldInfo.new({
    ...
    list[:total_population] = FieldInfo.new({
    ...
    list[:population_density] = FieldInfo.new({
    ...
    list[:death_rate_start_year] = FieldInfo.new({
    ...
    list[:death_rate_end_year] = FieldInfo.new({
    ...
    list[:death_rate_all_causes] = FieldInfo.new({
    ...
    list[:death_rate_cancer] = FieldInfo.new({
    ...
    list[:death_rate_heart_disease] = FieldInfo.new({
    ...
    list[:death_rate_all_accidents] = FieldInfo.new({
    ...
    list[:death_rate_transport_accidents] = FieldInfo.new({
